        ...
        <div style="background-color: #ffffff; padding: 24px; border-radius: 0 0 8px 8px; border: 1px solid #e2dcd3; border-top: none;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
            ...
            <tr>
              ...
              <td style="padding: 8px 0; border-bottom: 1px solid #f0eee9; color: #1a1a1a; font-size: 14px; text-align: right;">
                <a href="tel:${phone}" style="color: #4C0C0A; font-weight: bold;">${phone}</a>
              </td>
            </tr>
            <tr>
          ...
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
            ...
            <tr>
              ...
              <td style="padding: 8px 0; border-bottom: 1px solid #f0eee9; color: #4C0C0A; font-size: 14px; text-align: right; font-weight: bold;">${selectedCity}</td>
            </tr>
            <tr>
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #FAF7F2; padding: 24px; border-radius: 12px; border: 1px solid #e2dcd3;">
        ...
        <div style="background-color: #ffffff; padding: 24px; border-radius: 0 0 8px 8px; border: 1px solid #e2dcd3; border-top: none;">
          ...
          <div style="background-color: #f7f5f0; border: 1px solid #e2dcd3; border-radius: 8px; padding: 20px; margin: 24px 0;">
            <h3 style="color: #4C0C0A; font-size: 14px; text-transform: uppercase; letter-spacing: 1.5px; margin-top: 0; margin-bottom: 16px; border-bottom: 1px solid #e2dcd3; padding-bottom: 8px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr>
                ...
                <td style="padding: 6px 0; color: #4C0C0A; font-size: 14px; text-align: right; font-weight: bold;">${dancers} Entertainers (${performersDisplay})</td>
              </tr>
              <tr>
          ...
          <div style="border-top: 1px solid #e2dcd3; margin-top: 32px; padding-top: 20px; text-align: center;">
            ...
            <p style="margin: 8px 0 0 0;">
              <a href="tel:8439387377" style="color: #4C0C0A; font-weight: bold; text-decoration: none; font-size: 16px;">
