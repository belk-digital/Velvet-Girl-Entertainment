  ...
  return (
    <>
      ...
      <div className="px-6 pt-12 bg-black">
        <Reveal className="mx-auto flex max-w-3xl items-start gap-4 border border-[#380605]/30 bg-[#380605]/5 p-6 text-left shadow-sm">
          ...
          <p className="font-body text-sm sm:text-base leading-relaxed text-stone-300 font-medium">
            ...
            <span className="text-[#380605] font-bold">real, unedited photos</span> of
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                {group.cities.map((city) => (
                  <Link
                    ...
                    className="group flex items-center justify-between border border-white/10 bg-black px-6 py-5 font-body text-base font-bold text-white transition-all duration-300 hover:border-[#380605] hover:bg-[#380605] hover:text-white hover:shadow-md"
                  >
                    <div className="flex items-center gap-3">
                      <MapPin className="h-5 w-5 shrink-0 text-[#380605] group-hover:text-white transition-colors" />
                      <span>{city.name}</span>
                    </div>
      ...
      <Section eyebrow="DESTINATION BOOKINGS" title="Planning an event outside these cities?" theme="muted">
        <Reveal className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8">
            <Link
              href="/contact"
              className="tracking-caps inline-flex items-center gap-2 bg-white text-[#380605] px-9 py-4 font-body text-sm font-semibold transition-transform duration-300 hover:scale-105"
            >
