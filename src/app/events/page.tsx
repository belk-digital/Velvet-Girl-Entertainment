      ...
      <section className="py-20 md:py-32 max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
          <h2 className="font-sans font-bold text-3xl md:text-5xl text-white tracking-tight leading-tight">
            Upcoming <span className="text-[#380605]">Rallies & Events</span>
          </h2>
            ...
            >
              <div className="aspect-[16/9] w-full overflow-hidden relative">
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm text-white px-4 py-2 rounded-full flex items-center gap-2 text-sm font-bold uppercase tracking-wider">
                  <CalendarDays className="w-4 h-4 text-[#380605]" />
                  2027 Event
                </div>
              </div>
              
              <div className="p-8 md:p-10 flex-1 flex flex-col">
                <h3 className="font-display font-bold text-2xl md:text-3xl text-[#380605] mb-3">
                  {event.title}
                </h3>
                ...
                <div className="inline-flex items-center gap-2 text-white font-bold uppercase tracking-widest text-sm group-hover:text-[#380605] transition-colors mt-auto pt-4 border-t border-stone-100">
