        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-5">
          {benefits.map(({ icon: Icon, title }, i) => (
            <Reveal key={title} delay={i * 0.08}>
              <div className="h-full border border-white/10 rounded-xl bg-black p-8 text-center shadow-sm hover:border-[#540403]/50 hover:shadow-md transition-all">
                <span className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[#540403]/10 text-[#540403]">
      ...
      <div className="border-t border-white/10 bg-black px-6 py-20 sm:py-28">
        <Reveal className="mx-auto max-w-3xl">
          <div className="text-center">
            <p className="tracking-caps mb-3 font-body text-xs font-bold uppercase text-[#540403]">
              APPLICATION
            </p>
