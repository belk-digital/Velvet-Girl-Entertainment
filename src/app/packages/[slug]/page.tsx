          ...
          <Reveal className="mx-auto max-w-3xl text-center mt-2">
            {theme.comingSoon ? (
              <>
                ...
                <Link
                  href="/contact"
                  className="mt-10 inline-flex items-center gap-2 bg-white px-8 py-4 font-body text-xs font-bold uppercase tracking-widest text-[#540403] transition-all duration-300 hover:scale-105 border border-white shadow-md rounded-full"
                >
                  <span>NOTIFY ME</span>
                </Link>
              </>
