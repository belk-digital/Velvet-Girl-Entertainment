      ...
      >
        <Reveal className="mx-auto max-w-2xl text-center">
          <div className="p-8 sm:p-12 rounded-3xl bg-black border border-white/10 shadow-lg relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-bl from-[#540403]/10 to-transparent rounded-bl-full pointer-events-none" />
            ...
            <Link
              href="/book-now"
              className="inline-flex items-center gap-3 rounded-full bg-[#540403] px-8 py-4 font-heading text-sm sm:text-base font-bold uppercase tracking-wider text-white shadow-md transition-all hover:bg-[#5c0911] hover:scale-105"
            >
