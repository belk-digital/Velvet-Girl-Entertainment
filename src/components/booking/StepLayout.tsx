...
export default function StepLayout({
  ...
  return (
    ...
    >
      ...
      {!bgImage && (
        <>
          <div className="pointer-events-none absolute -left-32 -bottom-32 h-96 w-96 rounded-full bg-gradient-to-tr from-[#740107]/15 to-transparent blur-3xl" />
          <div className="pointer-events-none absolute -right-32 -top-32 h-96 w-96 rounded-full bg-gradient-to-bl from-[#740107]/10 to-transparent blur-3xl" />
        </>
      )}
