    ...
    <StepLayout stepKey={3} title="Where is the event?">
      <div className="max-w-md my-8">
        ...
        <div className="relative">
          <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 text-[#740107]">
      ...
      <div className="mt-12 mb-10 border-t border-stone-200/80 pt-10">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#740107]/10 text-[#740107] text-xs font-bold uppercase tracking-wider mb-2">
          ...
          {selectedList.length > 0 && (
            <div className="flex items-center gap-2 bg-[#740107] text-white px-4 py-2 rounded-full font-bold text-xs sm:text-sm shadow-md">
            ...
            return (
              <div
                ...
                className={`group relative flex flex-col justify-between bg-white rounded-[22px] border transition-all duration-300 overflow-hidden shadow-md hover:shadow-2xl hover:-translate-y-1.5 ${
                  isSelected
                    ? "border-[#740107] ring-2 ring-[#740107]/30 bg-red-50/20"
                    : "border-stone-200/90"
                }`}
              >
                {/* Top Image Area */}
                ...
                >
                  ...
                  {isSelected && (
                    <div className="absolute top-3.5 right-3.5 z-10">
                      <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#740107] text-white shadow-lg">
                  ...
                  <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <span className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-white/90 backdrop-blur-md text-xs font-bold text-stone-900 shadow-lg">
                      <Eye className="w-3.5 h-3.5 text-[#740107]" />
                      View Photos & Bio
                    </span>
                  </div>
                ...
                <div className="p-4 flex flex-col justify-between flex-grow gap-4">
                  ...
                  <button
                    ...
                    className={`w-full py-2.5 px-4 rounded-xl font-body text-xs font-bold uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-2 shadow-sm ${
                      isSelected
                        ? "bg-[#740107] text-white shadow-md hover:bg-[#8B0000]"
                        : "bg-stone-900 text-white hover:bg-[#740107]"
                    }`}
                  >
                    {isSelected ? (
                      <>
