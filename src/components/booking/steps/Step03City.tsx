      ...
      <div className="max-w-md my-8">
        ...
        <div className="relative">
          ...
          <select
            ...
            className="w-full appearance-none rounded-2xl border border-white/10 bg-black pl-12 pr-10 py-4 font-body text-base font-semibold text-white outline-none transition-all duration-300 focus:border-[#380605] focus:ring-2 focus:ring-[#380605]/20 shadow-sm cursor-pointer"
          >
