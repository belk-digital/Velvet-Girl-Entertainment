        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full appearance-none rounded-2xl border border-black/20 bg-white pl-12 pr-4 py-4 font-body text-base font-semibold text-stone-800 outline-none transition-all duration-300 focus:border-[#380605] focus:ring-2 focus:ring-[#380605]/20 shadow-sm cursor-pointer"
            />
          </div>
        </div>
