        ...
        <div className="mb-8 p-6 rounded-2xl bg-black border border-white/10 shadow-sm">
          <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
            ...
            <button
              type="button"
              onClick={() => goToStep(3)}
              className="text-xs font-bold uppercase tracking-wider text-[#380605] hover:underline"
            >
              Edit Selection
            </button>
          </div>
          ...
          {selectedPerformersList.length > 0 ? (
            ...
            <div className="p-4 rounded-xl bg-black border border-white/10 text-stone-300 text-sm flex items-center justify-between flex-wrap gap-3">
              ...
              <button
                type="button"
                onClick={() => goToStep(3)}
                className="px-4 py-2 rounded-xl bg-stone-900 text-white text-xs font-bold uppercase tracking-wider hover:bg-[#380605] transition-all"
              >
        ...
        <div className="mt-8 p-6 rounded-2xl bg-black border border-white/10 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-stone-400">
                  <User className="h-4 w-4 text-[#380605]" />
                </div>
                <input
                  id="booking-name"
                  type="text"
            ...
            <div>
              ...
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-stone-400">
                  <Phone className="h-4 w-4 text-[#380605]" />
                </div>
                <input
                  id="booking-phone"
                  type="tel"
            ...
            <div>
              ...
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-stone-400">
                  <Mail className="h-4 w-4 text-[#380605]" />
                </div>
                <input
                  id="booking-email"
                  type="email"
