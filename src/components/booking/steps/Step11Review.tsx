      ...
      <div className="max-w-4xl my-6">
        ...
        <div className="mb-8 p-6 rounded-2xl bg-black border border-white/10 shadow-sm">
          <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
            <h3 className="font-display text-base sm:text-lg font-bold text-white flex items-center gap-2">
              <Sparkles className="w-4 h-4 text-[#4C0C0A]" />
              <span>Selected VIP Entertainers</span>
            </h3>
            <button
              type="button"
              onClick={() => goToStep(3)}
              className="text-xs font-bold uppercase tracking-wider text-[#4C0C0A] hover:underline"
            >
              Edit Selection
            </button>
          </div>
          ...
          {selectedPerformersList.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {selectedPerformersList.map((p) => (
                ...
                >
                  <div className="relative w-14 h-14 rounded-full overflow-hidden bg-stone-200 shrink-0 border-2 border-[#4C0C0A]/20">
                    <Image
                      src={p!.image}
                      alt={p!.name}
                      fill
                  ...
                  <div className="min-w-0">
                    ...
                    <span className="block text-[11px] font-semibold text-[#4C0C0A] uppercase truncate">
                      {p!.location}
                    </span>
            ...
            <div className="p-4 rounded-xl bg-black border border-white/10 text-stone-300 text-sm flex items-center justify-between flex-wrap gap-3">
              <div>
                <p className="font-semibold text-white flex items-center gap-1.5">
                  <CheckCircle2 className="w-4 h-4 text-[#4C0C0A]" />
              ...
              <button
                type="button"
                onClick={() => goToStep(3)}
                className="px-4 py-2 rounded-xl bg-stone-900 text-white text-xs font-bold uppercase tracking-wider hover:bg-[#4C0C0A] transition-all"
              >
        ...
        <div className="mt-8 p-6 rounded-2xl bg-black border border-white/10 shadow-sm">
          <h3 className="font-display text-base sm:text-lg font-bold text-white mb-4 flex items-center gap-2">
            <Lock className="w-4 h-4 text-[#4C0C0A]" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-stone-400">
                  <User className="h-4 w-4 text-[#4C0C0A]" />
                </div>
                <input
                  id="booking-name"
                  type="text"
                  ...
                  className="w-full rounded-xl border border-white/10 bg-black pl-10 pr-4 py-3 font-body text-sm font-semibold text-white placeholder-stone-400 outline-none transition-all focus:border-[#4C0C0A] focus:ring-2 focus:ring-[#4C0C0A]/20"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-stone-400">
                  <Phone className="h-4 w-4 text-[#4C0C0A]" />
                </div>
                <input
                  id="booking-phone"
                  type="tel"
            ...
            <div>
              ...
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-stone-400">
                  <Mail className="h-4 w-4 text-[#4C0C0A]" />
                </div>
                <input
                  id="booking-email"
                  type="email"
