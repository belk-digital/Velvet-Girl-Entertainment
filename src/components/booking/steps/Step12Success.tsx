    ...
    <StepLayout stepKey={12}>
      <div className="flex flex-col items-center justify-center text-center max-w-xl mx-auto py-8 sm:py-12">
        ...
        <motion.div
          ...
          className="relative mb-8 flex h-24 w-24 sm:h-28 sm:w-28 items-center justify-center rounded-full bg-gradient-to-tr from-[#540403]/15 to-[#540403]/5 border-2 border-[#540403]/30 shadow-xl"
        >
          <div className="flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-full bg-[#540403] text-white shadow-lg">
        ...
        >
          <button
            type="button"
            disabled
            className="w-full inline-flex items-center justify-center gap-2 bg-[#540403] text-white px-8 py-4 rounded-2xl font-body text-base font-bold tracking-wide shadow-lg opacity-95 cursor-default mb-4"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 text-stone-300 hover:text-[#540403] font-body text-sm font-semibold transition-colors"
          >
