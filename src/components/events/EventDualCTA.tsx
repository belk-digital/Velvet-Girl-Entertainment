...
export default function EventDualCTA() {
  return (
    <section className="py-16 md:py-24 bg-black relative overflow-hidden">
      {/* Background Accents */}
      <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-[#4C0C0A]/5 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-5 lg:px-8 relative z-10">
        <Reveal>
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="font-sans font-bold text-3xl md:text-4xl lg:text-5xl text-white tracking-tight leading-tight">
              Ready to Join the{" "}
              <span className="font-script text-[#4C0C0A] text-4xl md:text-5xl lg:text-6xl font-normal block mt-2">
        ...
        <Reveal delay={0.2}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12">
            {/* Left CTA: Book Girls */}
            <div className="group relative overflow-hidden rounded-[2rem] bg-black border border-white/10 p-8 md:p-12 transition-all duration-500 hover:shadow-2xl hover:border-[#4C0C0A]/20 flex flex-col items-center text-center">
              <div className="absolute inset-0 bg-gradient-to-br from-[#4C0C0A]/0 to-[#4C0C0A]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
              
              <div className="w-16 h-16 rounded-full bg-white shadow-sm flex items-center justify-center mb-6 text-[#4C0C0A] group-hover:scale-110 transition-transform duration-500">
              ...
              <Link 
                href="/book-now"
                className="mt-auto inline-flex items-center gap-2 bg-black hover:bg-[#4C0C0A] text-white rounded-full px-8 py-4 font-bold text-sm tracking-widest uppercase transition-all duration-300 shadow-md group-hover:shadow-lg"
              >
                <span>Book Now</span>
            ...
            <div className="group relative overflow-hidden rounded-[2rem] bg-[#4C0C0A] text-white border border-[#590105] p-8 md:p-12 transition-all duration-500 hover:shadow-2xl flex flex-col items-center text-center">
              ...
              <Link 
                href="/join-team"
                className="mt-auto inline-flex items-center gap-2 bg-white hover:bg-black text-[#4C0C0A] hover:text-white rounded-full px-8 py-4 font-bold text-sm tracking-widest uppercase transition-all duration-300 shadow-[0_4px_15px_rgba(0,0,0,0.1)] group-hover:shadow-[0_8px_25px_rgba(0,0,0,0.2)]"
              >
