    ...
    <div className="relative w-full min-h-screen bg-black text-white overflow-hidden font-body pb-28 sm:pb-36">
          ...
          <Reveal>
            <div className="max-w-3xl flex flex-col items-center lg:items-start text-center lg:text-left pl-0 sm:pl-12 md:pl-24 lg:pl-32 xl:pl-36">
              <div className="flex items-center gap-3 mb-4">
                <Sparkles className="h-5 w-5 text-[#380605]" />
                <span className="font-body text-xs font-bold uppercase tracking-widest text-[#380605]">
              ...
              <div className="inline-flex items-center gap-2 bg-white/90 border border-white/10 px-4 py-2.5 rounded-full text-xs font-semibold text-stone-300 shadow-sm">
                <ShieldCheck className="w-4 h-4 text-[#380605]" />
      ...
      <section className="relative z-20 max-w-[120rem] mx-auto px-5 sm:px-6 lg:px-12 py-8 border-b border-white/10 bg-black/95 backdrop-blur-md sticky top-0">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto pb-2 md:pb-0 scrollbar-none">
            <button className="px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider whitespace-nowrap transition-all duration-300 bg-[#380605] text-white shadow-md scale-105">
              Event Photos
            </button>
          </div>

          <div className="text-xs font-bold uppercase tracking-wider text-stone-400 self-end md:self-center">
            Showing <span className="text-[#380605]">{eventGalleryImages.length}</span>{" "}
          ...
          {eventGalleryImages.map((src, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-end justify-between">
                <div>
                  <span className="inline-block px-2.5 py-1 rounded-md bg-[#380605] text-white text-[10px] font-bold uppercase tracking-widest mb-1.5 shadow-sm">
                    Events
                  </span>
      ...
      {activePhoto && (
        ...
        >
          ...
          >
            <div>
              <span className="inline-block px-3 py-1 rounded-full bg-[#380605] text-white text-xs font-bold uppercase tracking-widest">
                Events
              </span>
          ...
          >
            <Link
              href="/book-now"
              onClick={closeLightbox}
              className="px-6 py-3 rounded-full bg-[#380605] hover:bg-[#590105] text-white text-xs sm:text-sm font-bold uppercase tracking-wider shadow-lg transition-all"
            >
              Book For Your Event
            </Link>
            <a
