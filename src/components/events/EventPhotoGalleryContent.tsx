      ...
      <section className="relative z-20 max-w-[120rem] mx-auto px-5 sm:px-6 lg:px-12 py-8 border-b border-stone-200/80 bg-[#FAF7F2]/95 backdrop-blur-md sticky top-0">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto pb-2 md:pb-0 scrollbar-none">
            <button className="px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider whitespace-nowrap transition-all duration-300 bg-[#740107] text-white shadow-md scale-105">
              Event Photos
            </button>
          </div>

          <div className="text-xs font-bold uppercase tracking-wider text-stone-500 self-end md:self-center">
            Showing <span className="text-[#740107]">{eventGalleryImages.length}</span>{" "}
