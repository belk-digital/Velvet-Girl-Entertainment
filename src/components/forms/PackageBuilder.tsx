  ...
  return (
    <div className="border border-white/10 bg-black p-6 sm:p-10 shadow-sm">
      ...
      <div className="mt-6">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="flex h-11 w-11 items-center justify-center border border-white/10 bg-black text-white transition-all hover:border-[#380605] hover:bg-[#380605] hover:text-white"
            ...
            return (
              <label
                ...
                className={`flex items-start gap-3 border px-4 py-3.5 font-body text-xs cursor-pointer transition-all duration-300 ${
                  isChecked
                    ? "border-[#380605] bg-[#380605]/5 text-white font-semibold"
      ...
      <button
        ...
        className="tracking-caps mt-8 w-full bg-[#380605] px-8 py-4 font-body text-sm font-bold uppercase tracking-widest text-white transition-all duration-300 hover:scale-[1.01] hover:bg-[#5a0105] border border-[#380605] shadow-md cursor-pointer"
      >
        CONTINUE TO BOOKING
      </button>
    </div>
