          ...
          {performers.map((performer) => {
            ...
            return (
              <Link
                ...
                className="group flex h-full flex-col overflow-hidden rounded-[2rem] border border-white/10 bg-black transition-all duration-300 hover:border-[#380605]/60 hover:shadow-[0_0_30px_rgba(84,4,3,0.15)]"
              >
                {/* Image Section */}
                ...
                <div className="flex flex-1 flex-col justify-between p-6">
                  ...
                  <div className="mt-6 flex flex-col gap-3">
                    <div className="flex w-full items-center justify-center gap-2 rounded-full bg-[#380605] py-3.5 font-body text-[10px] font-bold uppercase tracking-widest text-white transition-colors hover:bg-[#5c0911]">
