    ...
    <div className="mt-16 md:mt-24">
      <div className="flex mb-6 rounded-md overflow-hidden border border-white/10 shadow-sm">
        <button 
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-4 font-bold text-sm tracking-widest transition-colors ${activeTab === "images" ? "bg-[#4C0C0A] text-white" : "bg-black text-white hover:bg-black"}`}
        >
        ...
        <button 
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-4 font-bold text-sm tracking-widest transition-colors border-l border-white/10 ${activeTab === "videos" ? "bg-[#4C0C0A] text-white" : "bg-black text-white hover:bg-black"}`}
        >
