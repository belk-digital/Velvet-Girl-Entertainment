  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-30 w-10 h-10 rounded-full bg-black/50 hover:bg-[#380605] text-white flex items-center justify-center transition-colors shadow-md backdrop-blur-sm"
        ...
        <div className="md:col-span-6 relative aspect-[3/4] md:aspect-auto md:h-full bg-stone-900 overflow-hidden">
          ...
          <div className="absolute top-4 left-4 flex flex-col gap-2 items-start z-10">
            ...
            {performer.isVerified && (
              <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-[#380605]/90 backdrop-blur-md text-[11px] font-bold uppercase tracking-wider text-white shadow-sm">
        ...
        <div className="md:col-span-6 p-6 sm:p-8 flex flex-col justify-between overflow-y-auto max-h-[85vh]">
          <div>
            ...
            <div className="hidden md:block">
              <div className="flex items-center justify-between gap-2">
                <h2 className="font-display text-3xl sm:text-4xl font-bold tracking-tight text-[#380605]">
                  {performer.name}
                </h2>
              </div>
            ...
            <div className="mt-6">
              <h4 className="font-body text-xs font-bold uppercase tracking-widest text-stone-400 mb-2 flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5 text-[#380605]" />
              ...
              <div className="grid grid-cols-2 gap-2">
                {(
                  ...
                  >
                    <div className="w-1.5 h-1.5 rounded-full bg-[#380605] flex-shrink-0" />
          ...
          <div className="mt-8 pt-6 border-t border-white/10 flex flex-col gap-2.5 w-full">
            <a
              href="tel:8439387377"
              className="w-full inline-flex items-center justify-center gap-2.5 bg-[#380605] hover:bg-[#5c0911] text-white px-6 py-3.5 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wider transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.01] whitespace-nowrap"
            >
