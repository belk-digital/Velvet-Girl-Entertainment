        ...
        >
          <defs>
            <linearGradient id={`${uid}vf1`} x1="0" y1="0" x2="1" y2="1">
              ...
              <stop offset="55%" stopColor="#540403" />
            ...
            >
              ...
              <stop offset="40%" stopColor="#540403" stopOpacity="0.2" />
      ...
      >
        <defs>
          <linearGradient id={`${uid}bv1`} x1="0" y1="1" x2="0" y2="0">
            <stop offset="0%" stopColor="#540403" />
            <stop offset="30%" stopColor="#540403" />
          ...
          <linearGradient id={`${uid}bv2`} x1="0" y1="1" x2="1" y2="0">
            <stop offset="0%" stopColor="#540403" />
            <stop offset="35%" stopColor="#540403" />
            <stop offset="75%" stopColor="#5c0911" />
            <stop offset="100%" stopColor="#1a0001" stopOpacity="0" />
          </linearGradient>
        </defs>

        <path d="M0 220 L1440 220 L1440 240 L0 240 Z" fill="#540403" />
        <path
