...
export default function CitiesSection({
  ...
  return (
    <section className="w-full bg-[#540403] py-20 md:py-32 font-sans border-t border-white/10 overflow-hidden flex flex-col items-center">
      ...
      <div
        ...
        style={{
          perspective: '1200px',
          maskImage: 'linear-gradient(to right, transparent, #540403 15%, #540403 85%, transparent)',
          WebkitMaskImage: 'linear-gradient(to right, transparent, #540403 15%, #540403 85%, transparent)'
        }}
      >
