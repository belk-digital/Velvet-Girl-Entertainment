        ...
        <Reveal>
          <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-8 md:gap-0 relative">
            ...
            <div className="md:col-span-6 xl:col-span-6 z-30 relative py-2 md:pr-8 lg:pr-12">
              ...
              >
                Ready to Plan <br />
                <span className="font-script font-normal text-[#540403] text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-none block sm:inline my-1">
                  Your Event?
                </span>{" "}
                <br />
              ...
              <div ref={leftBtnRef} className="mt-6 flex flex-col items-start gap-3.5">
                <Link
                  href="/book-now"
                  className="inline-flex items-center justify-center bg-[#540403] hover:bg-[#590105] text-white font-bold text-sm tracking-widest uppercase px-8 py-3.5 rounded-full shadow-[0_10px_25px_rgba(92, 0, 5,0.35)] hover:shadow-[0_15px_30px_rgba(92, 0, 5,0.5)] transition-all duration-300 hover:scale-105"
                >
                  BOOK ONLINE
                </Link>
            ...
            <div className="md:col-span-6 xl:col-span-6 z-10 md:ml-4 lg:ml-8 xl:ml-12 2xl:ml-16">
              <div className="bg-[#540403] text-white rounded-xl py-8 sm:py-10 lg:py-12 pr-6 sm:pr-8 lg:pr-12 pl-6 sm:pl-8 md:pl-14 lg:pl-20 xl:pl-24 min-h-[440px] lg:min-h-[500px] xl:min-h-[560px] 2xl:min-h-[600px] shadow-2xl relative overflow-hidden border border-white/10 flex flex-col justify-between">
