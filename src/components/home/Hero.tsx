    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center min-h-screen lg:min-h-0 bg-black/45 lg:bg-black w-full lg:w-[52%] xl:w-[50%] flex-shrink-0 px-8 sm:px-12 lg:px-14 xl:px-20 pt-28 pb-16 lg:py-0">
        <h1
          ...
          className="relative font-script font-normal leading-[1.15] opacity-0 text-4xl sm:text-5xl lg:text-[3.25rem] xl:text-[3.75rem] text-white lg:text-[#540403]"
        >
          {title}
        </h1>
        ...
        >
          <a
            href="tel:8439387377"
            className="tracking-caps group flex items-center justify-center gap-2 rounded-full bg-white text-[#540403] hover:bg-white/90 lg:bg-[#540403] lg:text-white lg:hover:bg-[#5c0911] px-5 py-3 sm:px-8 sm:py-5 font-body text-xs sm:text-sm font-bold transition-all duration-300 hover:scale-105 shadow-lg"
          >
