      ...
      <div className="max-w-[120rem] mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 mb-16 md:mb-24">
          ...
          <div className="review-header-element max-w-2xl">
            <p className="text-xs md:text-sm font-bold uppercase tracking-widest text-[#540403] mb-3" data-cms-section={sectionId ?? undefined} data-cms-type="reviews" data-cms-field="eyebrow">
              {eyebrow || "REVIEWS"}
            </p>
          ...
          <div className="review-header-element flex items-center gap-4 shrink-0 pb-2">
            <button 
              ...
              className="w-14 h-14 bg-[#540403] flex items-center justify-center text-white hover:bg-[#5c0911] transition-colors disabled:opacity-30 disabled:hover:bg-[#540403] cursor-pointer disabled:cursor-not-allowed group"
            >
              ...
              >
                <div className="mb-12">
                  <div className="inline-flex items-center gap-3 border border-white/20 rounded-full px-5 py-2 mb-8">
                    <div className="w-2 h-2 rounded-full bg-[#540403]"></div>
