    ...
    >
      ...
      <div className="mb-20 md:mb-32 w-full">
        <div className="relative">
          <h2 className="text-6xl sm:text-8xl md:text-[9rem] font-black uppercase text-[#380605] leading-[0.9] tracking-tighter relative z-30">
          ...
          <h2 
            ...
            style={{ WebkitTextStroke: '2px #380605' }}
            aria-hidden="true"
          >
            OUR <br className="md:hidden" /> SERVICES
          </h2>
          <h2 
            ...
            style={{ WebkitTextStroke: '2px #380605', opacity: 0.4 }}
            aria-hidden="true"
          >
            OUR <br className="md:hidden" /> SERVICES
          </h2>
