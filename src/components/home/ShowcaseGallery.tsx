...
export default function ShowcaseGallery({
  ...
  return (
    <section ref={containerRef} className="w-full bg-[#540403] text-white relative py-12 md:py-20 font-sans border-t border-white/10 overflow-hidden">
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 flex flex-col md:flex-row items-center justify-between mt-12 pb-8 gap-8">
        ...
        <div className="flex items-center gap-6 self-start md:self-auto w-full md:w-auto">
          <button className="bg-white text-[#540403] w-14 h-14 md:w-16 md:h-16 flex items-center justify-center hover:bg-black hover:text-white transition-colors shrink-0">
        ...
        <div className="flex items-center justify-between w-full md:w-auto gap-6 self-end md:self-auto">
          ...
          <Link
            href={linkHref}
            className="border-2 border-white/30 rounded-full w-12 h-12 md:w-14 md:h-14 flex items-center justify-center text-white hover:bg-black hover:text-[#540403] hover:border-white transition-colors shrink-0"
