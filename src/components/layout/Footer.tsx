...
export default function Footer() {
  ...
  return (
    <footer ref={containerRef} className="relative w-full bg-black overflow-hidden flex flex-col items-center pt-0 pb-12 font-sans">
      {/* Background Glows */}
      <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-[#540403] rounded-full blur-[220px] opacity-10 -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
      <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-[#540403] rounded-full blur-[220px] opacity-10 translate-x-1/3 translate-y-1/3 pointer-events-none"></div>
      ...
      <div className="footer-watermark absolute top-0 left-0 -translate-x-[2%] -translate-y-[10%] pointer-events-none z-0">
        <div
          aria-hidden="true"
          className="text-[9rem] sm:text-[14rem] md:text-[18rem] lg:text-[23rem]   text-[#540403] leading-none tracking-normal select-none "
          style={{
      ...
      <div className="footer-watermark absolute bottom-0 right-0 translate-x-[5%] translate-y-[15%] pointer-events-none z-0">
        <div
          aria-hidden="true"
          className="text-[9rem] sm:text-[14rem] md:text-[18rem] lg:text-[24rem] text-[#540403]/12 leading-none tracking-normal select-none "
        >
          GIRLS
        </div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[120rem] mx-auto px-6 lg:px-12 flex flex-col lg:flex-row items-start lg:items-end justify-between gap-12 pb-8">
        ...
        <div className="footer-content-item flex flex-col gap-6 md:gap-8 shrink-0">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="#"
              className="w-11 h-11 rounded-full bg-white shadow-[0_4px_15px_rgba(0,0,0,0.08)] border border-white/10 flex items-center justify-center text-black hover:bg-[#540403] hover:text-white transition-all duration-300 hover:scale-105"
              aria-label="Telegram"
            >
        ...
        <div className="footer-content-item grid grid-cols-2 gap-x-10 gap-y-2.5 font-medium text-white/75 text-sm md:text-base">
          <div className="flex flex-col gap-2.5">
            <Link href="/services" className="hover:text-[#540403] transition-colors lowercase">services</Link>
            <Link href="/girls" className="hover:text-[#540403] transition-colors lowercase">girls</Link>
            <Link href="/gallery" className="hover:text-[#540403] transition-colors lowercase">gallery</Link>
            <Link href="/packages" className="hover:text-[#540403] transition-colors lowercase">packages</Link>

            <Link href="/cities" className="hover:text-[#540403] transition-colors lowercase">cities</Link>
            <Link href="/about" className="hover:text-[#540403] transition-colors lowercase">about us</Link>
            <Link href="/blog" className="hover:text-[#540403] transition-colors lowercase">blog</Link>
          </div>
          <div className="flex flex-col gap-2.5">
            <Link href="/faq" className="hover:text-[#540403] transition-colors lowercase">faq</Link>
            <Link href="/join-team" className="hover:text-[#540403] transition-colors lowercase">join team</Link>
            <Link href="/privacy" className="hover:text-[#540403] transition-colors lowercase">privacy</Link>
            <Link href="/terms" className="hover:text-[#540403] transition-colors lowercase">terms</Link>
            <Link href="/disclaimer" className="hover:text-[#540403] transition-colors lowercase">18+ disclaimer</Link>
          </div>
        </div>
        ...
        <div className="footer-content-item whitespace-nowrap my-2 lg:my-0">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-[4.2rem] font-black leading-[0.93] tracking-tight lowercase">
            ...
            <span className="text-[#540403]">assist you</span>
          </h2>
        </div>
        ...
        <div className="footer-content-item flex flex-col items-start lg:items-center gap-3.5 shrink-0 mt-2 lg:mt-0">
          <Link
            href="/book-now"
            className="w-full bg-gradient-to-r from-[#540403] to-[#5a0105] text-white font-extrabold text-xs sm:text-sm py-4 px-10 text-center hover:from-[#5a0105] hover:to-[#540403] transition-all duration-300 tracking-widest uppercase rounded-full shadow-[0_10px_25px_rgba(92, 0, 5,0.35)] hover:shadow-[0_15px_30px_rgba(92, 0, 5,0.5)] hover:scale-105"
          >
            BOOK NOW
          </Link>
          <div className="flex flex-col items-start lg:items-center gap-1">
            <a
              href="tel:8439387377"
              className="text-white/80 hover:text-[#540403] transition-colors text-sm md:text-base font-semibold"
            >
              (843) 938-7377
            </a>
            <a
              href="mailto:bookings@velvetgirlentertainment.com"
              className="text-white/80 hover:text-[#540403] transition-colors text-sm md:text-base font-medium"
            >
              bookings@velvetgirlentertainment.com
            </a>
            <a
              href="mailto:inquiries@velvetgirlentertainment.com"
              className="text-white/60 hover:text-[#540403] transition-colors text-xs md:text-sm font-medium"
            >
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="font-body text-xs text-white/40 pl-7">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#540403] hover:underline"
            >
              Belk Digital
            </a>
          </p>
