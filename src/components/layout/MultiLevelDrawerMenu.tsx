          ...
          <div className="mldm_panel_inner">
            ...
            <div className="mt-auto pt-8">
              <Link
                href="/book-now"
                onClick={closeMenu}
                className="flex items-center justify-center w-full px-6 py-4 bg-[#540403] hover:bg-[#5c0911] text-white font-body text-sm font-bold uppercase tracking-widest transition-colors duration-200"
              >
                Book Now
              </Link>
            </div>
