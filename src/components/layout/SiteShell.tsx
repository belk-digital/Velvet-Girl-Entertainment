  ...
  return (
    <div className="flex min-h-full flex-col bg-black">
      ...
      {!isBookingFlow && (
        ...
        <a
          href="tel:8439387377"
          className="flex items-center gap-1.5 sm:gap-2 rounded-full bg-[#380605] hover:bg-[#5c0911] text-white px-3 sm:px-5 py-2 sm:py-3 text-[10px] sm:text-sm font-bold uppercase tracking-wider shadow-md transition-all duration-300 hover:scale-105"
