...
export default function SiteShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-full flex-col bg-black">
      ...
      {!isBookingFlow && (
        <div className="fixed bottom-3 right-3 sm:bottom-6 sm:right-6 z-[100] flex flex-row items-center gap-1.5 sm:gap-2.5 bg-white/95 backdrop-blur-md p-1 sm:p-2 rounded-full shadow-[0_8px_30px_rgba(0,0,0,0.35)] border border-white/10">
        <a
          href="tel:8439387377"
