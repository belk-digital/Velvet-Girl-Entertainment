...
export default function BoatPartyHighlights() {
  const features = [
    {
      icon: <Sun className="h-8 w-8 text-[#540403]" strokeWidth={1.5} />,
      title: "DAY OR NIGHT",
      desc: "Poolside or evening celebrations",
    },
    {
      icon: <Droplets className="h-8 w-8 text-[#540403]" strokeWidth={1.5} />,
      title: "SWIMWEAR READY",
      desc: "Performances by the water",
    },
    {
      icon: <Users className="h-8 w-8 text-[#540403]" strokeWidth={1.5} />,
      title: "LARGE GROUPS",
      desc: "Perfect for the whole crew",
    },
    {
      icon: <Music className="h-8 w-8 text-[#540403]" strokeWidth={1.5} />,
      title: "HIGH ENERGY",
      desc: "Unforgettable atmosphere",
    },
    {
      icon: <Camera className="h-8 w-8 text-[#540403]" strokeWidth={1.5} />,
      title: "PHOTOS",
      desc: "Memories to last a lifetime",
    },
    {
      icon: <Shirt className="h-8 w-8 text-[#540403]" strokeWidth={1.5} />,
  ...
  return (
    <section ref={container} className="relative w-full overflow-hidden bg-black py-8 lg:py-20 min-h-0 lg:min-h-[800px]">
      ...
      <div ref={textRef} className="w-[55%] lg:w-[55%] xl:w-[60%] pl-4 pr-2 lg:px-6 lg:pl-16 xl:pl-24 relative z-10 flex flex-col justify-center mt-4 lg:mt-0 pb-6 lg:pb-0 min-h-[320px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-0">
        <p className="text-[#540403] text-[10px] sm:text-xs md:text-base font-bold tracking-widest uppercase mb-2 lg:mb-4 border-t-[1.5px] lg:border-t-2 border-[#540403] pt-1 lg:pt-2 inline-block max-w-max">
          HIGHLIGHTS
        </p>
        <h2 className="font-display text-[32px] leading-[1] sm:text-5xl md:text-6xl lg:text-7xl font-bold uppercase tracking-wide text-white mb-3 lg:mb-6">
          WHAT TO<br className="lg:hidden" /> <span className="text-[#540403]">EXPECT</span>
        </h2>
      ...
      <div className="w-full px-2 sm:px-6 lg:pl-16 xl:pl-24 relative z-10 lg:w-[55%] xl:w-[60%]">
        ...
        <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-8 lg:gap-x-6 max-w-3xl">
          {features.map((feat, i) => (
            <div key={i} className="flex flex-col items-center lg:items-start text-center lg:text-left group">
              ...
              <h3 className="font-bold text-[9px] sm:text-xs lg:text-[15px] text-[#540403] lg:text-white uppercase mb-1 tracking-wider leading-tight">{feat.title}</h3>
              <p className="text-[8px] sm:text-[10px] lg:text-[13px] text-stone-300 leading-tight px-1 lg:px-0">{feat.desc}</p>
              <div className="w-6 lg:w-8 h-[1.5px] lg:h-[2px] bg-[#540403]/40 mt-1.5 lg:mt-3 group-hover:w-10 group-hover:bg-[#540403] transition-all duration-300"></div>
            </div>
          ))}
        </div>
        ...
        <div ref={bannerRef} className="mt-8 lg:mt-16 flex items-center lg:items-start gap-3 lg:gap-4 bg-[#3d0f0f] lg:bg-transparent border-t-0 lg:border-t-2 border-white/10 p-3 lg:p-0 pt-3 lg:pt-6 rounded-lg lg:rounded-none mx-2 lg:mx-0 max-w-2xl shadow-md lg:shadow-none mb-4 lg:mb-0">
          <div className="bg-black lg:bg-[#540403] rounded-full p-2 lg:p-2.5 text-[#3d0f0f] lg:text-white shrink-0 shadow-sm">
            <Star className="h-4 w-4 lg:h-5 lg:w-5" fill="currentColor" />
          </div>
          <div>
            <h4 className="font-bold text-white lg:text-[#540403] text-[11px] sm:text-sm lg:text-base leading-tight">Elevate your party.</h4>
            <p className="text-[9px] sm:text-xs lg:text-sm text-stone-300 lg:text-stone-300 mt-0.5 leading-tight lg:leading-normal pr-2">Let our entertainers keep the energy high from dock to deep water.</p>
          </div>
        </div>
      </div>
