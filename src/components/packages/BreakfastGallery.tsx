...
const images = [
  "/images/Breakfast with babes.jpg",
  "/gallery images/BREAKFAST WITH BABES.webp",
];

export default function BreakfastGallery() {
  ...
  return (
    <section ref={container} className="w-full bg-black py-16 lg:py-24">
      <div className="max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div ref={headerRef} className="mb-10 lg:mb-16 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <div>
            <div className="flex items-center gap-3 mb-4 lg:mb-6">
              <div className="w-3.5 h-3.5 rounded-full border border-[#4C0C0A]/50"></div>
              <p className="text-[#4C0C0A] text-xs font-bold tracking-widest uppercase">
                GALLERY
              </p>
            </div>
          ...
          <div className="max-w-xs md:text-right hidden sm:block">
            <p className="text-stone-400 text-[10px] md:text-xs font-bold tracking-wider uppercase leading-relaxed">
              Explore the highlights and best moments from our breakfast parties.
            </p>
          </div>
        </div>
        ...
        <div 
          ref={gridRef}
          className="grid grid-cols-1 sm:grid-cols-2 gap-4 auto-rows-[400px] max-w-4xl mx-auto"
        >
          {images.map((src, index) => {
            return (
              ...
              >
                <Image
                  src={src}
                  alt={`Breakfast Gallery Image ${index + 1}`}
                  fill
