    ...
    <div className="mb-8 w-full">
      ...
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="inline-flex h-6 items-center justify-center rounded-full bg-[#380605] px-2.5 font-body text-[10px] font-bold uppercase tracking-wider text-white shadow-sm">
      ...
      <div className="relative mb-6 h-1.5 w-full overflow-hidden rounded-full bg-black/10">
        <div
          className="h-full bg-gradient-to-r from-[#380605] to-[#a30008] transition-all duration-500 ease-out"
          ...
          return (
            <button
              ...
              className={`group flex items-center gap-2.5 rounded-xl border px-3 py-2.5 text-left transition-all duration-300 ${
                isCurrent
                  ? "border-[#380605] bg-[#380605]/5 shadow-sm"
                  : isCompleted
                  ? "border-white/10 bg-black hover:border-[#380605]/40 cursor-pointer"
            ...
            >
              <span
                className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-xs font-bold transition-all duration-300 ${
                  isCompleted
                    ? "bg-[#380605] text-white group-hover:scale-105"
                    : isCurrent
                    ? "border-2 border-[#380605] bg-white text-[#380605]"
