...
export default function HowToBookTimeline({
  ...
  return (
    <div className={`relative overflow-hidden rounded-3xl border border-[#740107]/20 p-8 sm:p-12 lg:p-16 shadow-2xl ${className}`}>
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden bg-[#FAF7F2]">
        ...
        <div className="absolute inset-x-0 bottom-0 h-4/5 bg-gradient-to-t from-[#740107]/25 via-[#740107]/10 to-transparent" />

        {/* Vertical Spotlight Light Cones rising from bottom (using Velvet Crimson #740107 instead of Blue!) */}
        <div className="absolute -bottom-16 left-[10%] h-[85%] w-[25%] -translate-x-1/2 rounded-full bg-gradient-to-t from-[#740107]/35 via-[#740107]/12 to-transparent blur-3xl" />
        <div className="absolute -bottom-16 left-[30%] h-[95%] w-[25%] -translate-x-1/2 -rotate-6 rounded-full bg-gradient-to-t from-[#990000]/40 via-[#740107]/15 to-transparent blur-3xl" />
        <div className="absolute -bottom-16 left-[50%] h-[90%] w-[30%] -translate-x-1/2 rotate-6 rounded-full bg-gradient-to-t from-[#740107]/45 via-[#740107]/18 to-transparent blur-3xl" />
        <div className="absolute -bottom-16 left-[70%] h-[95%] w-[25%] -translate-x-1/2 -rotate-6 rounded-full bg-gradient-to-t from-[#990000]/40 via-[#740107]/15 to-transparent blur-3xl" />
        <div className="absolute -bottom-16 left-[90%] h-[85%] w-[25%] -translate-x-1/2 rounded-full bg-gradient-to-t from-[#740107]/35 via-[#740107]/12 to-transparent blur-3xl" />
      </div>
            ...
            <Reveal key={item.title} delay={i * 0.1}>
              <div className="flex flex-col items-start text-left group">
                ...
                <div className="h-9 mb-5 flex items-center">
                  <span className="inline-flex items-center rounded-full bg-white/95 px-4 py-1.5 font-body text-xs font-bold uppercase tracking-widest text-[#740107] border border-[#740107]/30 shadow-md group-hover:bg-[#740107] group-hover:text-white transition-all duration-300">
                    STEP 0{i + 1}
                  </span>
                </div>
                ...
                <div className="relative my-4 flex items-center w-full h-6">
                  ...
                  <div
                    className={`absolute top-1/2 -translate-y-1/2 h-[2px] bg-stone-300 transition-colors duration-300 group-hover:bg-[#740107]/40 ${
                      isFirst
                        ? "left-2 right-0"
                        : isLast
                        ? "left-0 right-5"
                  ...
                  {/* Circular Node Dot */}
                  <div className="relative z-10 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-white border-[3px] border-[#740107] ring-4 ring-[#740107]/15 shadow-sm group-hover:scale-125 transition-transform duration-300" />

                  {/* Right arrowhead terminating the roadmap */}
                  {isLast && (
                    <ArrowRight className="absolute right-0 top-1/2 -translate-y-1/2 h-5 w-5 text-stone-400 group-hover:text-[#740107] group-hover:translate-x-1 transition-all duration-300" />
                  )}
                </div>

                {/* 3. Step Title, Subtitle, & Description */}
                <div className="mt-5 pr-6 xl:pr-10">
                  <h3 className="font-display text-xl font-bold uppercase tracking-wider text-stone-900 group-hover:text-[#740107] transition-colors duration-300">
                    {item.title}
                  </h3>
                  {item.subtitle && (
          ...
          return (
            <Reveal key={item.title} delay={i * 0.08}>
              <div className="relative flex items-start gap-5 group">
                ...
                {!isLast && (
                  <div className="absolute left-[9px] top-7 bottom-[-40px] w-[2px] bg-stone-300 group-hover:bg-[#740107]/40 transition-colors duration-300" />
                )}

                {/* Circular Node Dot */}
                <div className="relative z-10 mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-white border-[3px] border-[#740107] ring-4 ring-[#740107]/15 shadow-sm group-hover:scale-125 transition-transform duration-300" />

                {/* Right content column */}
                <div className="flex-1 pb-2">
                  <div className="flex flex-wrap items-center gap-2.5">
                    <span className="inline-flex items-center rounded-full bg-white/95 px-3.5 py-1 font-body text-[11px] font-bold uppercase tracking-widest text-[#740107] border border-[#740107]/30 shadow-sm group-hover:bg-[#740107] group-hover:text-white transition-all duration-300">
                      STEP 0{i + 1}
                    </span>
                    {item.subtitle && (
                  ...
                  <h3 className="mt-3 font-display text-lg sm:text-xl font-bold uppercase tracking-wider text-stone-900 group-hover:text-[#740107] transition-colors duration-300">
                    {item.title}
                  </h3>
