...
export default function PerformerCard({ performer }: { performer: Performer }) {
  return (
    <div className="group flex h-full flex-col justify-between overflow-hidden border border-black/10 bg-white transition-all duration-300 hover:border-[#5C0005]/60 hover:shadow-xl">
      ...
      <div className="p-6 flex flex-col flex-1 justify-between bg-white">
        <div>
          <h3 className="font-display text-xl font-bold text-black group-hover:text-[#5C0005] transition-colors">
            {performer.name}
          </h3>
        ...
        <Link
          ...
          className="mt-6 pt-4 border-t border-black/10 flex items-center justify-between font-body text-xs font-semibold uppercase tracking-widest text-[#5C0005] transition-transform duration-300 group-hover:translate-x-1"
        >
