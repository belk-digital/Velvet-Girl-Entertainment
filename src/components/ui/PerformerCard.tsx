...
export default function PerformerCard({ performer }: { performer: Performer }) {
  return (
    <div className="group flex h-full flex-col justify-between overflow-hidden border border-white/10 bg-black transition-all duration-300 hover:border-[#540403]/60 hover:shadow-xl">
      <div className="relative flex aspect-[3/4] items-center justify-center overflow-hidden bg-gradient-to-br from-[#3b0003] via-[#540403] to-[#111111]">
      ...
      <div className="p-6 flex flex-col flex-1 justify-between bg-black">
        <div>
          <h3 className="font-display text-xl font-bold text-white group-hover:text-[#540403] transition-colors">
            {performer.name}
          </h3>
        ...
        <Link
          ...
          className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between font-body text-xs font-semibold uppercase tracking-widest text-[#540403] transition-transform duration-300 group-hover:translate-x-1"
        >
