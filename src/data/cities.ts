...
const raw: { state: string; stateSlug: string; cities: RawCity[] }[] = [
  {
    ...
    cities: [
      ...
      },
      {
        ...
        content: {
          intro:
            "Myrtle Beach is a year-round party town, and its combination of oceanfront rentals, golf resorts, and a wide-open nightlife scene makes it a natural fit for bachelor parties, birthday weekends, and group celebrations. Velvet Girl Entertainment books professional entertainers up and down the Grand Strand, from North Myrtle Beach down through Surfside Beach and Murrells Inlet, for private parties in vacation rentals, condos, and resort suites. Whether you're planning a golf weekend with a group of ten or a smaller beachfront birthday celebration, our Myrtle Beach performers are available to travel to your rental and keep the party going.",
          whyChooseUs:
  ...
  },
  {
    ...
    cities: [
      ...
      },
      {
        ...
        content: {
          intro:
            "Atlanta is one of the largest and most active markets we serve, with a nightlife scene spread across Midtown, Buckhead, and downtown that supports everything from birthday parties to large corporate events. Velvet Girl Entertainment books verified, professional entertainers throughout the greater Atlanta area for bachelor parties, VIP hospitality, corporate celebrations, and private events, with performers available to travel to high-rise condos, hotel suites, and private residences across the metro.",
          whyChooseUs:
  ...
  },
  {
    ...
    cities: [
      ...
      },
      {
        ...
        content: {
          intro:
            "Orlando and Daytona Beach cover two very different kinds of celebrations — resort pool parties and vacation rentals near International Drive, and beachfront bachelor weekends along the Daytona Beach Boardwalk. Velvet Girl Entertainment books professional entertainers across both areas for pool parties, bachelor celebrations, and private events, with performers available to travel to resort suites, vacation homes, and beachfront condos.",
          whyChooseUs:
    ...
    cities: [
      {
        ...
        content: {
          intro:
            "Indianapolis has a growing bachelor party and private-event scene anchored by the Mass Ave entertainment district downtown and the bar-heavy strip in Broad Ripple. Velvet Girl Entertainment books professional entertainers throughout the Indianapolis metro for bachelor parties, birthdays, and private celebrations, especially around major sporting events and race weekends when the city sees a significant spike in group travel.",
          whyChooseUs:
